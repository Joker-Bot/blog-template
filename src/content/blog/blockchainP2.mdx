...
- Hashing:
	...
	* Cryptographic hash functions are one of the most important techniques in the field of 	cryptography and are used to accomplish many safety goals such 
        as authentication, digital signatures, generation of pseudo numbers, 
	digital steganography, digital time-stamping, etc.
...
- Wallet:
	...
	* A Blockchain wallet offers all the features available for safe and 
	...
	There are three types of cryptocurrency wallets : </span>
