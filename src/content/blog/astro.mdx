...
<span style="color: red;">Public Blockchain:</span> 
...
Here, more than one central entity is in charge of deciding and providing read, write, and audit access to pre-selected nodes in the blockchain. Only consortium members can make, validate, and review transactions.
This type is suitable for use between companies that often have dealings with each other. While these are more secure, they come at the cost of decentralization. However, this suits enterprise use cases and business processes.
